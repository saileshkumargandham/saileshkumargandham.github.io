        ...
        <div id="layoutSidenav">
			...
			<div class="container" align="center">
				<div class="card" style="width: 18rem;">
				  <img class="card-img-top" src="gallery/logs/dislike.png"  alt="Failed to Load Image">
				  <div class="card-body">
					<p class="card-text"><b style="color:red">Record is already existed!</b></p>
					<button onclick="document.location='dashboard.php'" class="btn btn-danger">Ok</button>
				  </div>
				</div>			
							</div>
			</main>
